...
def GraficoVPython(theta, phi, vw_x, vw_y, vw_z, omegax, omegay, omegaz):
    ...
    Entradas:
        ...
        vw_x: valor deseado de la componente en x de la velocidad del viento.
        vw_y: valor deseado de la componente en y de la velocidad del viento.
        vw_z: valor deseado de la componente en z de la velocidad del viento.
    ...
    # Condiciones Iniciales
    # Movimiento x (Condiciones iniciales)
    vx0 = rapidezInicial * np.cos(theta * conversion) * np.cos(phi * conversion)
    x0 = 0

    # Movimiento y (Condiciones iniciales)
    vy0 = rapidezInicial * np.cos(theta * conversion) * np.sin(phi * conversion)
    y0 = 0

    # Movimiento z (Condiciones iniciales)
    vz0 = rapidezInicial * np.sin(theta * conversion)
    z0 = 0
